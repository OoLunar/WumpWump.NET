...
namespace WumpWump.Net.Rest.RateLimits
{
    public class DiscordRateLimiter : IDiscordRateLimiter
    {
        ...
        protected readonly ILogger<DiscordRateLimiter> _logger;

        public DiscordRateLimiter(ILogger<DiscordRateLimiter>? logger = null) => _logger = logger ?? NullLogger<DiscordRateLimiter>.Instance;
