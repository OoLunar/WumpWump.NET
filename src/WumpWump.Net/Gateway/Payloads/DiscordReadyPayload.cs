...
namespace WumpWump.Net.Gateway.Entities
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="Guilds"/> are the guilds of which your bot is a member. They start out as unavailable when you connect to the
    /// gateway. As they become available, your bot will be notified via Guild Create events.
    /// </remarks>
    public readonly record struct DiscordReadyPayload
    {
        /// <summary>
        ...
        /// </summary>
        public required IReadOnlyList<DiscordGuild> Guilds { get; init; }
