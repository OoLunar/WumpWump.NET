...
namespace WumpWump.Net.Json
{
    ...
    {
        /// <inheritdoc/>
        public override DiscordOptional<T> Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => JsonSerializer.Deserialize<T>(ref reader, options)!;
